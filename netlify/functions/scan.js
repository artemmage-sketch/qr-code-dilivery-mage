...
Поля:
- establishment: ПОВНА назва закладу як написано на чеку — слово в слово, нічого не скорочувати і не змінювати (наприклад "Temari Sushi Тарнавського Тернопіль")
